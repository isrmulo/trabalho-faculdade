    ...
    <footer className="bg-foreground text-background py-12 md:py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            <h3 className="text-xl font-semibold mb-4">Pé Direito</h3>
        ...
        <div className="mt-12 pt-8 border-t border-background/20 text-center text-sm font-light opacity-70">
          <p>&copy; {new Date().getFullYear()} Pé Direito. Todos os direitos reservados.</p>
